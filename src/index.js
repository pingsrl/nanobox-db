...
class NanoboxDbCommand extends Command {
	async run() {
		const { flags } = this.parse(NanoboxDbCommand);
...
NanoboxDbCommand.description = `Open the database of the current nanobox project in your favorite IDE`;

NanoboxDbCommand.flags = {
...
module.exports = NanoboxDbCommand;
